...
# Embedded file name: /MIDI Remote Scripts/pushbase/loop_selector_component.py
...
class LoopSelectorComponent(Component, Messenger):
    ...
    def _on_press_loop_selector_matrixParse error at or near `COME_FROM' instruction at offset 122_2
