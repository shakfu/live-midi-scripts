...
# Embedded file name: /MIDI Remote Scripts/pushbase/special_session_component.py
...
class ClipSlotCopyHandler(Messenger):
    ...
    def _start_copyingParse error at or near `JUMP_FORWARD' instruction at offset 74

    def _finish_copyingParse error at or near `JUMP_FORWARD' instruction at offset 56
...
class SpecialClipSlotComponent(ClipSlotComponent, Messenger):
    ...
    def _do_launch_clipParse error at or near `JUMP_FORWARD' instruction at offset 54
