...
# Embedded file name: /MIDI Remote Scripts/Launchkey_MK3/launchkey_mk3.py
...
class Launchkey_MK3(InstrumentControlMixin, NovationBase):
    ...
    def _extract_product_id_bytes(self, midi_bytes):
        ...
        if id_bytes[:3] == sysex.NOVATION_MANUFACTURER_ID and model_id_byte in midi.MODEL_ID_BYTES:
