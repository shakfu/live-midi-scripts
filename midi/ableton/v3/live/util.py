...
# Embedded file name: /MIDI Remote Scripts/ableton/v3/live/util.py
# Compiled at: 2024-08-28 00:56:44
# Size of source mod 2**32: 13926 bytes
...
def selected_chain(device):
    if is_device_rack(device) and device.view.is_showing_chain_devices:
