...
# Embedded file name: /MIDI Remote Scripts/ableton/v3/control_surface/components/clip_slot.py
...
class ClipSlotComponent(Component, Renderable):
    ...
    def _on_launch_button_released(self):
        if self.launch_button.is_momentary and not self._any_modifier_pressed():
