...
# Embedded file name: /MIDI Remote Scripts/ableton/v3/control_surface/components/recording.py
...
class SelectedSlotRecordingMethod(RecordingMethod):
    ...
    def _record_in_slot(self, slot):
        if not (slot.is_playing and self.song.is_playing) and slot.has_clip:
            slot.stop()
