...
# Embedded file name: /MIDI Remote Scripts/ableton/v3/control_surface/components/transport.py
...
class TransportComponent(Component, Renderable):
    ...
    def __init__(self, name='Transport', *a, **k):
        ...
        self.loop_length_encoder.connect_property(song,
          "loop_length",
          transform=(lambda x: max(self._position_encoder_increment_fn(), song.loop_length + self._position_encoder_increment_fn() * sign(x))))
