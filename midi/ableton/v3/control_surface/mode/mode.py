...
# Embedded file name: /MIDI Remote Scripts/ableton/v3/control_surface/mode/mode.py
...
class ShowDetailClipMode(Mode):
    ...
    def enter_mode(self):
        self._needs_restore_view = self._view.is_view_visible("Detail") and self._view.is_view_visible("Detail/DeviceChain", False) and not self._view.is_view_visible("Detail/Clip", False)
