...
# Embedded file name: /MIDI Remote Scripts/ableton/v2/base/event.py
...
class Slot(Disconnectable):
    ...
    def connect(self):
        if (self.is_connected or self.subject_valid)(self._subject) and self._listener is not None:
