...
# Embedded file name: /MIDI Remote Scripts/ableton/v2/control_surface/components/device_navigation.py
...
def nested_device_parent(device):
    if device.can_have_chains and device.view.is_showing_chain_devices:
