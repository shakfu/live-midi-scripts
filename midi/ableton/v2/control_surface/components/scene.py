...
# Embedded file name: /MIDI Remote Scripts/ableton/v2/control_surface/components/scene.py
...
class SceneComponent(Component):
    ...
    def _on_launch_button_released(self):
        if is_button_pressed(self._select_button) or liveobj_valid(self._scene) and not is_button_pressed(self._duplicate_button):
