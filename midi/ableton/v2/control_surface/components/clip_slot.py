...
# Embedded file name: /MIDI Remote Scripts/ableton/v2/control_surface/components/clip_slot.py
...
class ClipSlotComponent(Component):
    ...
    def _on_launch_button_released(self):
        if self.launch_button.is_momentary and not is_button_pressed(self._select_button):
            if liveobj_valid(self._clip_slot) and not is_button_pressed(self._duplicate_button):
