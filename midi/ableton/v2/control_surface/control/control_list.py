...
# Embedded file name: /MIDI Remote Scripts/ableton/v2/control_surface/control/control_list.py
...
class ControlList(Control):
    ...
    class State(Control.State):
        ...
        def control_count(self, count):
            ...
            if not len(self._controls) != count or dynamic_create and self._dynamic_create != dynamic_create:
