...
# Embedded file name: /MIDI Remote Scripts/_Framework/ChannelStripComponent.py
...
class ChannelStripComponent(ControlSurfaceComponent):
    ...
    def _on_mute_changed(self):
        if self.is_enabled():
            if not self._mute_button != None or self._track != None or self.empty_color == None:
    ...
    def _on_solo_changed(self):
        if self.is_enabled():
            if not self._solo_button != None or self._track != None or self.empty_color == None:
    ...
    def _on_arm_changed(self):
        if self.is_enabled():
            if not self._arm_button != None or self._track != None or self.empty_color == None:
