...
# Embedded file name: /MIDI Remote Scripts/_MxDCore/MxDCore.py
...
from _Framework.Disconnectable import Disconnectable as Disconnectable
...
class MxDCore(object):
    ...
    def _object_attr_path_iterParse error at or near `JUMP_LOOP' instruction at offset 124
    ...
    def _extract_dict_from_parameters(self, parameters):
        result = None
        if len(parameters) > 0 and isinstance(parameters[0], string_types):
            try:
