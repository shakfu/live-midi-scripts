...
# Embedded file name: /MIDI Remote Scripts/Push2/timeline_navigation.py
...
class SimplerWaveformNavigation(TimelineNavigation, WaveformNavigation):
    ...
    def object_changed(self, identifier1, identifier2):
        if self.selected_slice_focus in (identifier1, identifier2) and self._get_selected_slice_index() == 0:
