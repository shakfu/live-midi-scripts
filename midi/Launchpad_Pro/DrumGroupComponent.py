...
# Embedded file name: /MIDI Remote Scripts/Launchpad_Pro/DrumGroupComponent.py
...
class DrumGroupComponent(ResettableSlideComponent, Slideable):
    ...
    def _update_pad_ledParse error at or near `JUMP_FORWARD' instruction at offset 108
