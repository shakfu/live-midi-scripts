...
# Embedded file name: /MIDI Remote Scripts/_Axiom/Encoders.py
...
class Encoders(object):
    ...
    def set_bankParse error at or near `JUMP_FORWARD' instruction at offset 68
