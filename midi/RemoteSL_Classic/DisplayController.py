...
# Embedded file name: /MIDI Remote Scripts/RemoteSL_Classic/DisplayController.py
...
class DisplayController(RemoteSLComponent):
    ...
    def __generate_strip_string(self, display_string):
        ...
        if len(display_string.strip()) > NUM_CHARS_PER_DISPLAY_STRIP - 1 and display_string.endswith("dB"):
